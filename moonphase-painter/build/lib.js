...
function getMoonphaseChar(matrix, x, y) {
...
function output(str, width, height, scale = 1) {
...
function outputMoonphaseText(matrix, width, height, scale = 0.1) {
    output(matrix.map(x => x.join("")).join("\n"), width, height, scale);
}
function getMoonphaseText(canvas, pixelSize) {
