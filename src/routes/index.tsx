    ...
    return (
        <>
            <section>
                <h2>关于我</h2>
                <p>
                    宅宅, 懒癌, 运动白痴, 社交障碍, 三分钟热度, 不会骑自行车, 器用贫乏, 程序员. 喜欢摸小猫, P社4萌, 怪猎, 编程爱好者, 图形学
                    <ruby>
                        业余爱好者<rp>[</rp>
                        <rt>min ke</rt>
                        <rp>]</rp>
            ...
            <section>
                ...
                <div>
                    <ul>
                        <li>
                            ...
                            <div>
                                <ol>
                                    ...
                                    <li>
                                        我希望强类型能覆盖前端开发的方方面面, 包括路由, react-router等路由库, 其参数的正确性仅仅是基于开发的自觉,
                                        如果采用了typescript, 我们可以改善这一点, 这里没有直接用react-router.
                                    </li>
                                </ol>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                <ol>
                                    ...
                                    <li>
                                        轮子本身代码量很少, 主要是展示这个想法, 也就是用函数代替字符串的action, 当然这么做有利有弊,
                                        利在于更清晰的代码条理(不需要搜action的type来搜reducer逻辑了), 更少的模式代码, 弊端是性能下降,
                                        丧失了redux-devtool的支持.
                                    </li>
                                </ol>
                            </div>
                        ...
                        <li>
                            <h3>
                                <a href="https://github.com/buhichan/graphql-mongoose-service-template">Graphql+Mongodb的CRUD后端生成器</a>
                            </h3>
