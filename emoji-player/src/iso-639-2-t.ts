...
export function getLanguageFromBuffer(code:number){
	const a =String.fromCharCode((code >> 10)+0x60)
	const b =String.fromCharCode((code >> 5) % 32+0x60)
	const c =String.fromCharCode(code % 32+0x60)
	const lang = languages[a+b+c]
	return lang? lang.int : `<undefined language ${a+b+c} >`
}
